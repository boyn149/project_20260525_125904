...
async def write_book1():
    """
    Phase 2: เขียนเนื้อหาสำหรับ book1 (แก้ไขให้ระบุ book_code ใน prompt)
    """
    print("🚀 Starting Phase 2: Writing Content for book1")
    ...
    async with await NotebookLMClient.from_storage() as client:
        # Add layer1-4.md ของ book1 เข้า sources
        layer_files = [
        ...
        # เริ่มเขียนเนื้อหาตามลำดับ (ระบุ book_code เพื่อป้องกันความสับสน)
        prompts = [
